...
const portrait = "/presentation-assets/portrait.jpeg";
        ...
        <div className="h-full relative overflow-hidden rounded-lg">
            ...
            >
                ...
                <motion.div variants={itemVariants} className="flex justify-center md:justify-end z-20">
                    <div className="relative w-72 md:w-96 aspect-[3/4] rounded-3xl grayscale overflow-hidden shadow-xl border border-border/60">
                        <Image
                            src={portrait}
                            alt="Portrait"
                            fill
